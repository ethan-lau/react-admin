            ...
            <section className="col-lg-7 connectedSortable">
              ...
              <div className="box box-success">
                ...
                <div className="box-body chat" id="chat-box">
                  <div className="item">
                    <img src="/static/img/user4-128x128.jpg" alt="user image" className="online"/>
                  ...
                  <div className="item">
                    <img src="/static/img/user3-128x128.jpg" alt="user image" className="offline"/>
                  ...
                  <div className="item">
                    <img src="/static/img/user2-160x160.jpg" alt="user image" className="offline"/>
              ...
              <div className="box box-info">
                ...
                <div className="box-body">
                  <form action="#" method="post">
                    ...
                    <div>
                      <textarea className="textarea" placeholder="Message" style={{width: '100%', height: 125, fontSize: 14, lineHeight: 18, border: '1px solid #dddddd', padding: 10}}></textarea>
                    </div>
                  </form>
                </div>
